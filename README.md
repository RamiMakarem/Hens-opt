...
[Pinch Analysis APP→](https://pinch-analysis-app.streamlit.app/)**[Formulations & Benchmarks Whitepaper →](FORMULATIONS_AND_BENCHMARKS.md)** &nbsp;|&nbsp; **[9-Month Architecture Evolution Log →](ARCHITECTURE_EVOLUTION.md)**
